...
const PARTITIONED_TABLES: PartitionedTable[] = [
  ...
  // DOC-11 RD-PER-003 (Sessão 8): peripheral_job, particionada mensalmente (RNF-ARQ-090).
  { tableName: 'peripheral_job', ensureFunctionSql: 'wms.ensure_peripheral_job_partition' },
];
