// Maps Postgres constraint violations (DOC-04 CHECK/UNIQUE/FK constraints) to
// deterministic HTTP errors instead of leaking raw driver errors. Duplicated
// from modules/cadastro|portaria/shared/db-error.util.ts (RNF-ARQ-001: each
// module is self-contained) rather than cross-imported.
...
export function mapRecebimentoDbError(error: unknown): never {
